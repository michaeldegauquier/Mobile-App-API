        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PswHash = table.Column<byte[]>(maxLength: 64, nullable: true),
                    PswSalt = table.Column<byte[]>(maxLength: 128, nullable: true),
                    AddressId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManageCompany = table.Column<bool>(nullable: false),
                    ManageUsers = table.Column<bool>(nullable: false),
                    ManageProjects = table.Column<bool>(nullable: false),
                    ManageProjectRoles = table.Column<bool>(nullable: false),
                    ManageProjectUsers = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<int>(nullable: false),
                    CompanyRoleId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
